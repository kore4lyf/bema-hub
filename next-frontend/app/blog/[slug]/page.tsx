          ...
          <div className="grid lg:grid-cols-4 gap-8">
            <article className="lg:col-span-3">
              ...
              <div className="prose prose-neutral dark:prose-invert max-w-none">
                ...
                <h2 id="what-is-bema">What is Bema Hub?</h2>
                <p>
                ...
                <h2 id="building-presence">Building Your Presence</h2>
                <p>
                ...
                <h2 id="engagement">Community Engagement</h2>
                <p>
              ...
              <Card className="p-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1">Bema Hub Team</h3>
                    ...
                    <Card key={i} className="p-4">
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm">Great article! This really helped me understand how to get started.</p>
                          <Button variant="ghost" size="sm" className="mt-2 h-8">Reply</Button>
                        </div>
                      </div>
                    </Card>
                  ))}
